...
export const testimonials: Testimonial[] = [
    {
        ...
        message:
            "Wellpath pharmaceutical products have shown consistent results with my patients. The formulations are safe, effective, and trusted by many in my clinic.",
        image: "https://placehold.co/600x400",
        city: "Mumbai",
    },
    {
        ...
        message:
            "Our customers are very happy with Wellpath pharmaceutical medicines and wellness products. They are affordable without compromising on quality.",
        image: "https://placehold.co/600x400",
        city: "Delhi",
    },
    {
        ...
        message:
            "I recommend Wellpath pharmaceutical antibiotics and syrups to my patients. The trust and reliability of the brand make my job easier.",
        image: "https://placehold.co/600x400",
        city: "Bengaluru",
    },
    {
        ...
        message:
            "Stocking Wellpath pharmaceutical products has boosted my pharmacy sales. Customers keep coming back for the quality and results.",
        image: "https://placehold.co/600x400",
        city: "Jaipur",
    },
    {
        ...
        message:
            "I trust Wellpath pharmaceutical syrups and tonics for children. They are safe, effective, and formulated with great care.",
        image: "https://placehold.co/600x400",
        city: "Kolkata",
    },
];
